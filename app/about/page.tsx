      ...
      <div className="flex flex-col gap-8 m-5 md:m-10">
        ...
        <div className="text-justify">
          ...
          <p>
            ...
            and friends. Whether you're a seasoned chef or just getting started
            in the kitchen, we have something for everyone. We aims to foster a
            virtual culinary paradise, fostering cultural exchange and
        ...
        <div className="bg-orange-50 p-5 md:p-10 text-justify">
          ...
          <p>
            ...
            adventures. Join our community, share your own recipes, and let's
            embark on a journey to discover the joy of cooking. This is an
            adventure platform for home cooks, professional chefs, and food
            enthusiasts. It celebrates shared human experiences through food,
            allowing users to share recipes and explore the world one dish at a
            time.
          </p>
        </div>
        ...
        <div className="px-5 md:px-10 text-center">
          ...
          <a href="mailto:jpsm83@hotmail.com" target="_blank" rel="noopener noreferrer">jpsm83@hotmail.com</a>
          </div>

          <div className="flex flex-row justify-center gap-8 md:gap-12">
            <a href="https:/www.facebook.com" target="_blank" ><GrFacebook size={30} /></a>
            <a href="https:/www.instagram.com" target="_blank" ><GrInstagram size={30} /></a>
            <a href="https:/www.pinterest.com" target="_blank" ><GrPinterest size={30} /></a>
            <a href="https:/www.youtube.com" target="_blank" ><GrYoutube size={30} /></a>
          </div>
        </div>

        <div className="text-justify mt-5 md:mt-10">
          <h3 className="font-bold text-lg drop-shadow-md">Third parts acknowledgments and credits</h3>
          <p>The Cool Bananas Recipy Library utilizes external resources and expresses gratitude for their services on our journey.</p>
          <ul className="list-disc pl-5 md:pl-10">
            <li>Gencraft - AI images provider - <a href="https://www.gencraft.com" target="_blank" className="underline">Learn more</a></li>
            <li>Openart - AI images provider - <a href="https://openart.ai/" target="_blank" className="underline">Learn more</a></li>
          </ul>
        </div>
