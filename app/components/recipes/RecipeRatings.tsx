    ...
    <div>
      ...
      <div className="flex flex-col gap-6 md:gap-10 cursor-default px-4 md:px-0 mt-6 md:mt-0">
        <div className="font-bold text-orange-500 text-2xl md:text-4xl text-center">
          Read, cook, eat,{" "}
          <span className="text-4xl md:text-6xl drop-shadow-lg font-extrabold align-middle">
            RATE
          </span>{" "}
          it...
        </div>
        <div className="text-gray-500 font-semibold text-center">
          Rate this creation and let us know what you thing about this recipe on
          the reviews bellow. Write your toughs in what could de done do to
          improve it or just leave yours complements for the chef.
        </div>
        <div className="bg-orange-50 flex flex-row justify-center p-6">
          <RatingRadio
            ...
            viewOnly={recipe.authorId === currentUser?.id}
          />
        </div>
