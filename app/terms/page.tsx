      ...
      <div className="flex flex-col gap-8 m-5 md:m-10 pb-5 md:pb-10">
        ...
        <div className="text-justify">
          ...
          <p>
            ...
            with economic interests, do not submit reviews in exchange for
            payment, and comply with the terms of the Agreement. If deemed to
            diminish the integrity, the Company may exclude, prohibit, or remove
        ...
        <div className="text-justify">
          ...
          <p>
            ...
            sells access to video content, used for software program
